...
public:
	...
	// Fill triangle using Bresenham Line Algorithm, for Triangle Rasterization
	// https://www.avrfreaks.net/sites/default/files/triangles.c && 
	// http://www.sunshine2k.de/coding/java/TriangleRasterization/TriangleRasterization.html#algo2

	void FillTriangle(int x1, int y1, int x2, int y2, int x3, int y3, wchar_t c = PIXEL_FULL, short col = FG_WHITE)
	{
