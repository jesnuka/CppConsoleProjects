...
// Based on Command Line First Person Shooter (FPS) Engine by @Javidx9 at OneLoneCoder.com 

void ConsoleFPS::RunEngine()
{
    // Screen Buffer
...
wstring ConsoleFPS::CreateMap(int mapWidth, int mapHeight, int mapMode)
{
    wstring map;
